...
FEEDS: dict[str, list[dict[str, str]]] = {
    ...
    "brokers": [
        ...
        _gn("Zerodha+Groww+Angel+One+broker+India+trading+news+2026", india=True),
        _gn("Demat+account+brokerage+charges+F&O+SEBI+broker+India+2026", india=True),
    ...
    "insurance": [
        ...
        _gn("insurance+India+LIC+health+term+IRDA+IRDAI+premium+policy", india=True),
        _gn("insurance+claim+settlement+premium+life+motor+health+India", india=True),
    ...
    "payment": [
        ...
        _gn("UPI+payment+India+NPCI+fintech+digital+wallet+2026", india=True),
        _gn("digital+payment+fintech+Visa+Mastercard+PayPal+news+2026"),
    ],
    "currency": [
        {"url": "https://www.fxstreet.com/rss/news", "source": "FXStreet"},
        {"url": "https://www.dailyfx.com/feeds/all", "source": "DailyFX"},
        _gn("forex+currency+USD+INR+EUR+JPY+exchange+rate+2026"),
        _gn("rupee+dollar+rate+RBI+forex+reserve+India+2026", india=True),
    ],
    "blockchain": [
        {"url": "https://cointelegraph.com/rss/tag/blockchain", "source": "CoinTelegraph"},
        {"url": "https://www.coindesk.com/arc/outboundfeeds/rss/", "source": "CoinDesk"},
        _gn("blockchain+Web3+DeFi+Ethereum+smart+contract+news+2026"),
    ],
    "crypto": [
        {"url": "https://cointelegraph.com/rss", "source": "CoinTelegraph"},
        {"url": "https://decrypt.co/feed", "source": "Decrypt"},
        {"url": "https://www.coindesk.com/arc/outboundfeeds/rss/", "source": "CoinDesk"},
        _gn("Bitcoin+Ethereum+crypto+price+market+news+2026"),
    ],
    "offers": [
        {"url": "https://www.cardinsider.com/feed/", "source": "CardInsider"},
        _gn("credit+card+cashback+offer+India+bank+2026", india=True),
        _gn("bank+offer+discount+deal+India+coupon+cashback+2026", india=True),
        _gn("Flipkart+Amazon+sale+offer+India+discount+deal+2026", india=True),
    ],
    # ── India Regional ───────────────────────────────────────────────────────
    ...
    "malayalam_cinema": [
        {"url": "https://www.onmanorama.com/entertainment.feeds.onmrss.xml", "source": "OnManorama Entertainment"},
        {"url": "https://www.cinemaexpress.com/stories.rss", "source": "Cinema Express"},
    ...
    "tamil_cinema": [
        ...
        _gn("Tamil+movie+review+trailer+OTT+premiere+2026", india=True, when="7d"),
    ],
    "telugu_cinema": [
    ...
    "kannada_cinema": [
        ...
        _gn("KGF+Kantara+Sandalwood+Kannada+OTT+release+award+2026", india=True, when="7d"),
    ],
    "mumbai": [
    ...
    "ai": [
        ...
        {"url": "https://feeds.arstechnica.com/arstechnica/index", "source": "Ars Technica AI"},
    ...
    "health": [
        ...
        _gn("health+news+India+AIIMS+hospital+WHO+disease+2026", india=True),
    ],
    "medicine": [
        {"url": "https://www.statnews.com/feed/", "source": "STAT News"},
        {"url": "https://feeds.bbci.co.uk/news/health/rss.xml", "source": "BBC Health"},
    ...
    "energy": [
        ...
        _gn("renewable+energy+solar+wind+green+hydrogen+news+2026"),
