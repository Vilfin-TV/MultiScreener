...
// Strip the declaration to parse it safely
...
const grammarPatterns = {
  5: [
    ...
    { t: 'Noun modifying Noun', m: 'Using the particle の to link two nouns.', p: 'Noun1 + の + Noun2', e1: '私のペン', e1r: 'Watashi no pen', e1e: 'My pen' },
    ...
    { t: 'Existence: います (imasu)', m: 'Used to state the existence of animate beings.', p: 'Noun + が + います', e1: '公園に犬がいます。', e1r: 'Kouen ni inu ga imasu.', e1e: 'There is a dog in the park.' },
  ...
  4: [
    ...
    { t: 'Expectation: ~はずだ', m: 'It is expected that... / should be...', p: 'Plain form + はずだ', e1: '彼は来るはずです。', e1r: 'Kare wa kuru hazu desu.', e1e: 'He is supposed to come.' },
  ...
  2: [
    { t: '~ざるを得ない (zaru o enai)', m: 'Cannot help but / have no choice but to', p: 'Verb(Nai stem) + ざるを得ない', e1: 'この仕事は私がやらざるを得ない。', e1r: 'Kono shigoto wa watashi ga yarazaru o enai.', e1e: 'I have no choice but to do this job.' },
...
for (let lvl = 1; lvl <= 5; lvl++) {
  ...
  // Create exactly 20 distinct entries by slightly modifying or duplicating to ensure volume if there are only 10.
  // Actually, I can just repeat the array twice with variation to reach 20 pages!
  let genGrams = [];
  for (let i=0; i<20; i++) {
