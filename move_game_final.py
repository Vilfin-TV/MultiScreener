...
def fix_layout():
    ...
    new_layout = """        <div id="jp-kana-section" class="kana-layout">
          <div>
            ...
            <!-- Recall Game Moved Under Left Column Grid -->
          ...
          <div class="kana-sidebar">
            ...
            <!-- Academy YouTube Panel -->
            <div class="kana-game-box" style="margin-top:20px; padding:0; overflow:hidden; border:1px solid var(--border);">
              <div class="kana-score-row" style="padding:12px 16px; border-bottom:1px solid var(--border); margin-bottom:0;">
                <span id="academy-video-header">LANGUAGE ACADEMY VIDEOS</span>
              </div>
              <iframe id="academy-video-iframe" 
                      style="width:100%; aspect-ratio:16/9; border:none; display:block; background:#000;" 
    ...
    print("Layout successfully adjusted!")
